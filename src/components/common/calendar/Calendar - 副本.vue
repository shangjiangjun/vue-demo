		...
		<div v-if="insert || show" class="uni-calendar__content" :class="{'uni-calendar--fixed':!insert,'uni-calendar--ani-show':aniMaskShow}">
			<div v-if="!insert" class="uni-calendar__header uni-calendar--fixed-top">
				<div class="uni-calendar__header-btn-box" @click="close">
					<span class="uni-calendar__header-text uni-calendar--fixed-width">取消</span>
				</div>
				<div class="uni-calendar__header-btn-box" @click="confirm">
					<span class="uni-calendar__header-text uni-calendar--fixed-width">确定</span>
				</div>
			</div>
			<div class="uni-calendar__header">
				...
				<div mode="date" :value="date" fields="month" @change="bindDateChange">
					<span class="uni-calendar__header-text">{{ (nowDate.year||'') +'年'+( nowDate.month||'') +'月'}}</span>
				</div>
			...
			<div class="uni-calendar__box">
				<div v-if="showMonth" class="uni-calendar__box-bg">
					<span class="uni-calendar__box-bg-text">{{nowDate.month}}</span>
				</div>
				<div class="uni-calendar__weeks">
					<div class="uni-calendar__weeks-day">
						<span class="uni-calendar__weeks-day-text">日</span>
					</div>
					<div class="uni-calendar__weeks-day">
						<span class="uni-calendar__weeks-day-text">一</span>
					</div>
					<div class="uni-calendar__weeks-day">
						<span class="uni-calendar__weeks-day-text">二</span>
					</div>
					<div class="uni-calendar__weeks-day">
						<span class="uni-calendar__weeks-day-text">三</span>
					</div>
					<div class="uni-calendar__weeks-day">
						<span class="uni-calendar__weeks-day-text">四</span>
					</div>
					<div class="uni-calendar__weeks-day">
						<span class="uni-calendar__weeks-day-text">五</span>
					</div>
					<div class="uni-calendar__weeks-day">
						<span class="uni-calendar__weeks-day-text">六</span>
					</div>
				</div>
